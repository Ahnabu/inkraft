        ...
        <GlassCard className="space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    maxLength={200}
                    rows={3}
                    className="w-full px-3 py-2 rounded-lg border border-border bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary resize-none transition-colors"
                />
            </div>
